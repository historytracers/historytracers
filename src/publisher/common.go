...
var indexFiles []string = []string{"gallery", "first_steps_menu", "first_steps", "first_steps_volume2", "shapes", "literature", "indigenous_who", "myths_believes", "math_games", "historical_events", "physics", "chemistry", "biology", "history", "philosophy", "atlas", "documentation"}

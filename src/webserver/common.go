...
var indexFiles []string = []string{"first_steps_menu", "first_steps", "literature", "indigenous_who", "myths_believes", "math_games", "historical_events", "physics", "chemistry", "biology", "history"}

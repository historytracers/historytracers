...
function htAddAlterQImages(id)
{
    ...
    $(id).html("");
    for (let i = 0; i < 4; i++) {
        $(id).append("<div class=\"htSlide\"> <div class=\"htSlideCounter\">"+(i + 1)+" / 4</div> <img id=\"imgCopan"+i+"\" onclick=\"htImageZoom('imgCopan"+i+"', '0%')\" class=\"imgGameSize\" src=\"images/CopanAltarGenealogy"+i+".jpg\"><div class=\"htSlideCaption\">"+kingOrder[i]+"</div></div>");
    }

...
function htFillPaperContent(table,last_update,page_authors,page_reviewers){var localLang=$("#site_language").val();var localCalendar=$("#site_calendar").val();$("#paper").html("<i>"+keywords[87]+"</i>");for(const i in table){if(i==1){htFillDivAuthorsContent("#paper",last_update,page_authors,page_reviewers);}

...
var imgIndex=getRandomArbitrary(0,htGameImages.length-5);$(opt0ac0098b.target).append("<p class=\"desc\"><img class=\"imgGameSizeWithOpacity\" src=\"images/"+htGameImages[imgIndex]+"\">"+keywords[71]+" "+htGameImagesLocation[imgIndex]+".</p>");}
...
var useText="";if(table[i].text!=undefined){if(table[i].text.constructor===vectorConstructor){var rows=table[i].text;for(const j in rows){useText+=rows[j];}}else{useText=table[i].text;}}

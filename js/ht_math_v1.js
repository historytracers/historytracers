...
function htWriteYupanaEquals(idx, txtIdx, tableID, resultID)
{
    var text = "<i>"+mathKeywords[txtIdx]+"</i><br /><i>"+mathKeywords[2]+"</i><br />";
    $(tableID+" "+resultID+idx).html(text);
}

function htWriteYupanaMovement(larr, rarr, tableID, rows, resultID)
{
    if (larr.length != rarr.length) {
        return;
    }
    ...
    for (let i = 0, j = larr.length; i < larr.length; i++, j--) {
        ...
        if (larr[i] == rarr_work[i]) {
            switch (larr[i]) {
                ...
                case 4:
                    ...
                    text += "<i>"+mathKeywords[3]+"</i><br />";
                    $(tableID+" "+resultID+j).html(text);
                    continue;
                case 2:
                    $(tableID+" "+resultID+j).html("<i>"+mathKeywords[0]+"</i><br />");
                    continue;
                case 3:
                    $(tableID+" "+resultID+j).html("<i>"+mathKeywords[1]+"</i><br />");
                    continue;
                case 5:
                    $(tableID+" "+resultID+j).html("<i>"+mathKeywords[2]+"</i><br />");
                    continue;
                case 6:
                    htWriteYupanaEquals(j, 3, tableID, resultID);
                    continue
                case 7:
                    htWriteYupanaEquals(j, 0, tableID, resultID);
                    continue
                case 8:
                    htWriteYupanaEquals(j, 1, tableID, resultID);
                    continue
                case 9:
                    text += "<i>"+mathKeywords[1]+"</i><br />"
                    text += "<i>"+mathKeywords[3]+"</i><br />"
        ...
        } else if (larr[i] != 0 && rarr_work[i] != 0) {
            var bigger = false;
            if (result > 10) {
                text = "<i>"+mathKeywords[2]+"</i><br />";
                result = result % 10; 
            ...
            switch (result) {
                ...
                case 7:
                    if (bigger) {
                        ...
                        if (larr[i] == 4 || rarr_work[i] == 4) {
                            text += "<i>"+mathKeywords[1]+"</i><br />"
                        }
                        else if (larr[i] == 5 || rarr_work[i] == 5) { 
                            break;
                        }
                        text += "<i>"+mathKeywords[3]+"</i><br />"
                    }
                ...
                case 9:
                    ...
                    continue;
                case 10:
                    if (larr[i] == 9 || rarr_work[i] == 9) {
                        text += "<i>"+mathKeywords[3]+"</i><br /><i>"+mathKeywords[4]+"</i><br />";
                    }
                    else if (larr[i] == 8 || rarr_work[i] == 8) {
                        text += "<i>"+mathKeywords[4]+"</i><br />";
                    }
                    else if (larr[i] == 7 || rarr_work[i] == 7) {
                        text += "<i>"+mathKeywords[4]+"</i><br />";
                    }
                    else if (larr[i] == 6 || rarr_work[i] == 6) {
                        text += "<i>"+mathKeywords[3]+"</i><br /><i>"+mathKeywords[4]+"</i><br />";
                    }
        ...
        if (text.length > 0) {
            ...
            $(tableID+" "+resultID+j).html(mathKeywords[5]+"<br />");
        }

...
function htImageZoom(id){var name=$("#"+id).prop("name");if(name.length==0){$("#"+id).attr("name","zoomin");$("#"+id).css("transform","scale(2.7)");}else{$("#"+id).attr("name","");$("#"+id).css("transform","scale(1)");}}

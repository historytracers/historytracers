...
var converter=new showdown.Converter();if(table!=undefined&&table==1){converter.setOption('tables',true);}
...
var author=(localAtlas[i].author!=undefined)?localAtlas[i].author:null;var isTable=(localAtlas[i].isTable!=undefined)?localAtlas[i].isTable:0;var format=(localAtlas[i].format!=undefined)?localAtlas[i].format:"html";htAtlas.push({"name":localAtlas[i].name,"image":localAtlas[i].image,"author":author,"text":text,"format":format,"isTable":isTable});var showIdx=parseInt(i)+1;var o=new Option(showIdx+". "+localAtlas[i].name,showIdx);$("#atlasindex").append(o);}

...
{for(let i=0,top2bottom=1;i<periods.length;i++,top2bottom++){$("#tmc"+outputColumn+"l"+top2bottom).html(periods[i]);$("#tmc1l"+top2bottom).attr('src','images/HistoryTracers/Maya_'+periods[i]+'.png');}}
...
$("#tmc"+outputColumn+"l"+top2bottom).attr('src','images/HistoryTracers/Maya_0.png');start/=20;top2bottom++;}
...
$("#tmc"+outputColumn+"l"+bottom2top).attr('src','images/HistoryTracers/Maya_'+rest+'.png');bottom2top--;}}

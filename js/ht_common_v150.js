...
htLoadIndex(data,arg,page);htLoadSources(data,arg,page);htProccessData(data,optional);return false;},});}
...
htLoadIndex(data,arg,page);htLoadSources(data,arg,page);htFillWebPage(page,data);return false;},});return false;}
